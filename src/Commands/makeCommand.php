...
class makeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if (file_exists($path . DIRECTORY_SEPARATOR . $this->argument('name'))) {
        ...
        foreach ($arguments as $key => $argument) {
            ...
            $trimmer = rtrim($pathCreated, DIRECTORY_SEPARATOR);

            if (!file_exists($path . DIRECTORY_SEPARATOR . $trimmer)) {
        ...
        // Route Web
        copy(__DIR__ . '/Stubs/web.stub', $path . '/' . $pathCreated . '/Routes/web.php');
        $str = file_get_contents($path . '/' . $pathCreated . '/Routes/web.php');
        ...
        file_put_contents($path . '/' . $pathCreated . '/Routes/web.php', $str);

        // route api
        copy(__DIR__ . '/Stubs/api.stub', $path . '/' . $pathCreated . '/Routes/api.php');
        ...
        // model
        copy(__DIR__ . '/Stubs/model.stub', $path . '/' . $pathCreated . '/Models/' . $argument[1] . '.php');
